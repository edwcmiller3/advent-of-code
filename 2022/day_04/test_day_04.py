...
def test_parse_ranges():
    section_range = "10-15"
    splitter = '-'
    result = day_04_part_01.parse_range(section_range, splitter)
...
def test_generate_ranges():
    parsed_range = ('10', '15')
    result = day_04_part_01.generate_range_set(parsed_range)
...
def test_find_subsets_return_0():
    ...
    result = day_04_part_01.find_subsets(range_set_A, range_set_B)
    assert result == 0
